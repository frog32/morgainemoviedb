...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Movie.mdbID'
        db.delete_column('moviedb_movie', 'mdbID')

        # Adding field 'Movie.tmdb_id'
        db.add_column('moviedb_movie', 'tmdb_id', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Movie.mdbID'
        db.add_column('moviedb_movie', 'mdbID', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'Movie.tmdb_id'
        db.delete_column('moviedb_movie', 'tmdb_id')
