...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Poster.imageThumb'
        db.delete_column('moviedb_poster', 'imageThumb')

        # Deleting field 'Poster.remotePath'
        db.delete_column('moviedb_poster', 'remotePath')

        # Deleting field 'Poster.sourceType'
        db.delete_column('moviedb_poster', 'sourceType')

        # Deleting field 'Poster.imageOriginal'
        db.delete_column('moviedb_poster', 'imageOriginal')

        # Adding field 'Poster.remote_path'
        db.add_column('moviedb_poster', 'remote_path', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'Poster.source_type'
        db.add_column('moviedb_poster', 'source_type', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'Poster.image_original'
        db.add_column('moviedb_poster', 'image_original', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Poster.image_thumb'
        db.add_column('moviedb_poster', 'image_thumb', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Poster.imageThumb'
        db.add_column('moviedb_poster', 'imageThumb', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Poster.remotePath'
        db.add_column('moviedb_poster', 'remotePath', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'Poster.sourceType'
        db.add_column('moviedb_poster', 'sourceType', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'Poster.imageOriginal'
        db.add_column('moviedb_poster', 'imageOriginal', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True), keep_default=False)

        # Deleting field 'Poster.remote_path'
        db.delete_column('moviedb_poster', 'remote_path')

        # Deleting field 'Poster.source_type'
        db.delete_column('moviedb_poster', 'source_type')

        # Deleting field 'Poster.image_original'
        db.delete_column('moviedb_poster', 'image_original')

        # Deleting field 'Poster.image_thumb'
        db.delete_column('moviedb_poster', 'image_thumb')
