...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Movie.resolution'
        db.alter_column('moviedb_movie', 'resolution', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True))

        # Changing field 'Poster.imageOriginal'
        db.alter_column('moviedb_poster', 'imageOriginal', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Movie.resolution'
        db.alter_column('moviedb_movie', 'resolution', self.gf('django.db.models.fields.TextField')(blank=True))

        # Changing field 'Poster.imageOriginal'
        db.alter_column('moviedb_poster', 'imageOriginal', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'Poster.name'
        db.alter_column('moviedb_poster', 'name', self.gf('django.db.models.fields.TextField')(max_length=200))
    ...
    models = {
        ...
        'moviedb.poster': {
            ...
            'name': ('django.db.models.fields.TextField', [], {'max_length': '200', 'blank': 'True'}),
