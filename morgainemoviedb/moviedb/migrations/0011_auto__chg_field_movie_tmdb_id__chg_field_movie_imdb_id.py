...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Movie.tmdb_id'
        db.alter_column('moviedb_movie', 'tmdb_id', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Movie.imdb_id'
        db.alter_column('moviedb_movie', 'imdb_id', self.gf('django.db.models.fields.CharField')(max_length=12, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Movie.tmdb_id'
        db.alter_column('moviedb_movie', 'tmdb_id', self.gf('django.db.models.fields.CharField')(max_length=12, blank=True))

        # Changing field 'Movie.imdb_id'
        db.alter_column('moviedb_movie', 'imdb_id', self.gf('django.db.models.fields.IntegerField')())
