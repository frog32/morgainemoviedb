...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('moviedb_bookmark', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('movie', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bookmarks', to=orm['moviedb.Movie'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bookmarks', to=orm['auth.User'])),
        ))
        db.send_create_signal('moviedb', ['Bookmark'])


    def backwards(self, orm):
        
        # Deleting model 'Bookmark'
        db.delete_table('moviedb_bookmark')
