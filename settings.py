...
# Django settings for morgainemoviedb project.
import os
...
SECRET_KEY = '-##o6j#a#ucbev!ap&3=q#4f+8mb3nn^l$n9_ep1l*^p$u5_@2'
...
ROOT_URLCONF = 'morgainemoviedb.urls'
